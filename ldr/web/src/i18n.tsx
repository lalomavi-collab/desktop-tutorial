...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "hero.lead": {
    he: "הפניות תיקים בין עורכי דין — מהיר, ישיר, בלי עמלות ובלי מתווכים. ותיקים שמגיעים ישירות מהלקוח, לפי מיקום, ניסיון והמלצות.",
    en: "Case referrals between attorneys — fast, direct, no fees and no middlemen. Plus cases that come straight from the client, by location, experience and reviews.",
    ru: "Передача дел между юристами — быстро, напрямую, без комиссий и посредников. И дела напрямую от клиента — по геолокации, опыту и отзывам.",
  },
