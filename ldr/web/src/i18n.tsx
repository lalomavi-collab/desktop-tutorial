...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "filter.region": { he: "אזור (ישראל)", en: "Region (Israel)", ru: "Регион (Израиль)" },
  "reg.all": { he: "כל הארץ", en: "All Israel", ru: "Весь Израиль" },
  "reg.center": { he: "מרכז", en: "Center", ru: "Центр" },
  "reg.jerusalem": { he: "ירושלים", en: "Jerusalem", ru: "Иерусалим" },
  "reg.north": { he: "צפון", en: "North", ru: "Север" },
  "reg.south": { he: "דרום", en: "South", ru: "Юг" },
  ...
  "office.sub": { he: "חדר פנוי? השכירו לעמית לפי שעות / יום / שבוע. תשלום ישיר, בלי עמלה.", en: "A free room? Rent it to a colleague by hour / day / week. Direct payment, no fee.", ru: "Свободный кабинет? Сдайте коллеге по часам/дням/неделям. Прямая оплата, без комиссии." },
  "svc.title": { he: "מה עושים ב-LAWdin", en: "What you do on LAWdin", ru: "Что вы делаете на LAWdin" },
  "svc.referrals": { he: "הפניות בין עו״ד", en: "Attorney referrals", ru: "Передача дел" },
  "svc.referralsD": { he: "ישיר, בלי עמלה", en: "Direct, no fee", ru: "Напрямую, без комиссии" },
  "svc.cases": { he: "תיקים מלקוחות", en: "Client cases", ru: "Дела от клиентов" },
  "svc.casesD": { he: "לקוח מפרסם, אתם מגיבים", en: "Clients post, you respond", ru: "Клиент публикует — вы отвечаете" },
  "svc.rooms": { he: "שיתוף חדרים", en: "Room sharing", ru: "Аренда кабинетов" },
  "svc.roomsD": { he: "לפי שעות/יום/שבוע", en: "By hour/day/week", ru: "По часам/дням/неделям" },
  "svc.jobs": { he: "דרושים + סינון AI", en: "Jobs + AI screening", ru: "Вакансии + ИИ-отбор" },
  "svc.jobsD": { he: "קו״ח ישיר, בלי עמלת כ״א", en: "CVs direct, no agency fee", ru: "Резюме напрямую, без комиссии" },
  ...
  "qa.disclaimer": {
    he: "⚠️ הבהרה: התשובות מבוססות על מערכות ומודלי AI קיימים, אינן מהוות ייעוץ משפטי ואינן תחליף לאיש מקצוע מורשה. השימוש באחריות אישית בלבד, ויש לאמת כל מידע מול עורך דין. אין כל אחריות מצד LAWdin.",
    en: "⚠️ Disclaimer: Answers are generated by existing AI systems/models, are not legal advice and are not a substitute for a licensed professional. Use is at your own responsibility; verify all information with an attorney. LAWdin assumes no liability.",
    ru: "⚠️ Отказ от ответственности: ответы создаются существующими системами ИИ, не являются юридической консультацией и не заменяют лицензированного специалиста. Использование под личную ответственность; проверяйте информацию у юриста. LAWdin не несёт ответственности.",
  },
