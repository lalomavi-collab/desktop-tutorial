...
const FEATURES = [
  {
    icon: "⏱️",
    title: "חסכו שעות בכל שבוע",
    body: "אין יותר WhatsApp קבוצות, פורומים מאולחשים ולינקדאין. כל מה שצריך — פיד, שו״ת, עמיתים ולידים — במקום אחד.",
  },
  {
    icon: "🤝",
    title: "לקוחות מגיעים אליכם — ללא עמלה",
    body: "אנשים פרטיים מחפשים עו״ד לפי תחום עיסוק ו-Authority Tier. כשאתם מאומתים — הם מוצאים אתכם. ללא עמלת תיווך.",
  },
  {
    icon: "🌍",
    title: "הפניות בינ״ל מאובטחות",
    body: "שלחו וקבלו תיקים חוצי-גבולות. מנגנון Escrow עם אבני-דרך וחתימה דיגיטלית — מדינות נוספות מצטרפות בהדרגה.",
  },
];
        ...
        <div className="auth-wrap">
          ...
          <div className="animate-in">
            ...
            <h1 style={{ margin: "0 0 18px", fontSize: "clamp(28px, 4vw, 44px)", lineHeight: 1.2, fontWeight: 900 }}>
              הפסיקו לבזבז זמן<br />
              <span className="gold">בפורומים ורשתות.</span><br />
              <span style={{ color: "var(--cream-dim)" }}>זה הבית שלכם.</span>
            </h1>

            <p style={{ fontSize: 16, lineHeight: 1.75, color: "var(--cream-dim)", maxWidth: 480, margin: "0 0 32px" }}>
              LAWDin היא הרשת הסגורה הראשונה לעורכי דין בישראל —
              עם <b style={{ color: "var(--cream)" }}>לידים ישירים מלקוחות ללא עמלה</b>,
              הפניות בינ״ל מאובטחות, ושיתוף ידע עם עמיתים מאומתים בלבד.
            </p>
