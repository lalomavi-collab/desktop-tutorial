...
avraham@lalum.co | +972-52-249-0420 | lalum.co`,
  ...
  // ── New — found 21.06.2026 (scan #2) ────────────────────────────────────
  {
    id: 'job-frame-security-1',
    title: 'Legal Counsel',
    ...
    description: 'Frame Security (Team8) — AI Human Security startup. First legal hire. Commercial SaaS agreements, NDAs, DPAs, privacy compliance. 4–6 years experience. AI engine for security awareness training and attack simulations. Backed by world-class investors.',
    tags: ['Tel Aviv', 'AI', 'Cybersecurity', 'Commercial', 'Privacy', 'Team8', 'First Hire'],
    score: 8.5,
    scoreReason: 'Frame Security — AI cybersecurity (Team8-backed), first legal hire, Jun 16 2026. Commercial+GDPR+DPA focus. AI era human security — ליבת פרופיל AI law. ציון גבוה.',
    scannedAt: '21.06.2026',
    decision: 'pending',
    toEmail: undefined,
    emailVerified: false,
  },
  {
    id: 'job-simply-1',
    title: 'Legal Counsel',
    company: 'Simply (Piano/Guitar/Sing)',
    location: 'Tel Aviv',
    toEmail: 'info@hellosimply.com',
    emailVerified: true,
    salary: 'לא פורסם',
    jobType: 'Full-time',
    url: 'https://jobera.com/job/simply-tv-legal-counsel-8d7a3e3e/',
    description: 'Simply — AI creative learning apps (Simply Piano, Guitar, Sing, Draw). 1M+ monthly downloads. First legal hire: build legal function from scratch. Commercial, privacy, IP, music licensing, M&A support. 5+ years post-bar.',
    tags: ['Tel Aviv', 'AI', 'Consumer', 'IP', 'Music Licensing', 'Privacy', 'First Hire', 'B2C'],
    score: 8.0,
    scoreReason: 'Simply — AI subscription consumer app, first legal hire, commercial+privacy+IP+music licensing. Strong AI angle + unique IP/content dimension. תל אביב. Posted Jun 4 2026.',
    scannedAt: '21.06.2026',
    decision: 'pending',
  },
  {
    ...
    location: 'Israel',
    toEmail: 'nir@classiq.io',
    emailVerified: true,
    salary: 'לא פורסם',
    jobType: 'Full-time',
    url: 'https://www.classiq.io/positions/position-49_B68',
    description: 'Classiq Technologies — Quantum computing + AI platform. Sole legal counsel, reports to CFO. Commercial SaaS agreements (global enterprise), IP, privacy/GDPR/CCPA/DPA, corporate governance. 5+ years, Israeli/US/EU bar. Native English+Hebrew.',
    tags: ['Israel', 'AI', 'Quantum Computing', 'SaaS', 'Commercial', 'Privacy', 'Sole Counsel'],
    score: 7.8,
    scoreReason: 'Classiq — Quantum+AI SaaS, sole counsel. Niche but cutting-edge tech, global enterprise clients, strong commercial+privacy scope. 5+ years fit.',
    scannedAt: '21.06.2026',
    decision: 'pending',
  },
  {
    id: 'job-hypernative-1',
    title: 'Legal Counsel',
    company: 'Hypernative',
    location: 'Herzliya',
    salary: 'לא פורסם',
    ...
    description: 'Hypernative — Web3/cybersecurity threat prevention. First in-house counsel. Commercial SaaS, NDAs, DPAs, partnerships. GDPR, DORA, NIS2, MiCA regulatory compliance. 3–5 years. Crypto/cybersecurity intersection.',
    tags: ['Herzliya', 'Cybersecurity', 'Web3', 'Privacy', 'Commercial', 'First Hire', 'Crypto'],
    score: 7.0,
    scoreReason: 'Hypernative — Web3/crypto niche, cybersecurity overlap. Borderline: less AI focus, crypto ecosystem specific. 3-5 years requirement — fit.',
    scannedAt: '21.06.2026',
    decision: 'pending',
    toEmail: undefined,
    emailVerified: false,
  },
  {
    ...
    description: 'Mixtiles ($300M profitable brand, ~100 people) — Legal Partner. Building the legal function from scratch. Commercial transactions, corporate law, privacy & data protection. 5+ years post-qualification, top-tier law firm + high-growth tech background.',
    tags: ['Tel Aviv', 'Commercial', 'Privacy', 'IP', 'Corporate', 'Scale-up', 'B2C'],
    score: 7.5,
    scoreReason: 'Mixtiles — חברה רווחית ב-$300M, בניית פונקציה משפטית מאפס. Commercial+Privacy+IP. פחות AI אבל fit מצוין לפרופיל. LinkedIn apply בלבד.',
    scannedAt: '21.06.2026',
    decision: 'pending',
    toEmail: undefined,
    emailVerified: false,
