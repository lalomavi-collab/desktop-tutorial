@echo off
rem רישום חד פעמית: משימה מתוזמנת ב-01 לכל חודש ב-09:00 שאוספת, בונה טבלה,
...
chcp 65001 >nul
schtasks /Create /F /TN "LALUM חשבוניות חודשי" /SC MONTHLY /D 1 /ST 09:00 /TR "%~dp0run_monthly.bat"
if errorlevel 1 (
    ...
    echo ואז משלימים ושולחים ידנית עם invoices.bat ואישור Y.
