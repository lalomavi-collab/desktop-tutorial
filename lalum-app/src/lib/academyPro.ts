...
export const academyPro: Course[] = [
  {
    ...
    sessions: [
      ...
      { n: 6, title: "רגולציה ופרויקט גמר: ה-EU AI Act ברמה הרלוונטית למשרד, תיקון 13 והגנת הפרטיות, חובות גילוי ללקוח, והצגת פרויקט הגמר" },
    ],
  },
  {
    ...
    ctaLabel: "לפרטים ולהרשמה",
    sessions: [
      { n: 1, title: "יסודות וגבולות גזרה: איך מודל שפה עובד ומה הוא לא, מפת הכלים, סודיות מזמין השומה, והמסגרת המקצועית שהתוצר חייב לעמוד בה" },
      ...
      { n: 6, title: "רגולציה ופרויקט גמר: אחריות מקצועית וחשיפה כששומה נשענת על כלי אוטומטי, שקיפות מול מזמין השומה, והצגת פרויקט הגמר" },
    ],
  },
  {
    ...
    sessions: [
      ...
      { n: 6, title: "רגולציה ופרויקט גמר: אחריות מקצועית, גילוי ללקוח, והצגת פרויקט הגמר" },
    ],
  },
];
