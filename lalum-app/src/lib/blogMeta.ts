...
export const blogMeta: BlogMeta[] = [
  {
    "slug": "portugal-porto-vs-lisbon",
    "title": "נדל״ן בפורטוגל: פורטו מול ליסבון, איך בוחרים עיר למשקיע הישראלי",
    "excerpt": "השוואה בין פורטו לליסבון למשקיע נדל״ן ישראלי: אופי שתי הערים, שיקולי תשואה וסיכון, וההיבטים המשפטיים שכדאי לבדוק לפני הבחירה, עם דגש על חוות דעת בלתי תלויה ובדיקת נאותות בסיוע Legal AI.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/portugal-realestate-investment.webp"
  },
  {
    "slug": "portugal-real-estate-taxation",
    "title": "מיסוי נדל״ן בפורטוגל לתושב ישראל: מס מקומי, אמנת המס ודיווח בישראל",
    "excerpt": "מדריך למיסוי השקעת נדל״ן בפורטוגל עבור תושב ישראל: המסים המקומיים ברכישה ובהחזקה, מיסוי דמי שכירות ורווח הון, אמנת המס למניעת כפל מס, וחובת הדיווח בישראל על הכנסה מכל העולם.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/international-trade-guide-2026.webp"
  },
  {
    "slug": "portugal-purchase-contract",
    "title": "חוזה רכישת נדל״ן בפורטוגל: מה שונה מחוזה ישראלי ואיך מגנים על המקדמה",
    "excerpt": "מדריך לחוזה רכישת נדל״ן בפורטוגל: שלב חוזה ההבטחה מול שטר המכר, מה שונה מעסקה ישראלית, כיצד מגנים על המקדמה, ומדוע ליווי משפטי עצמאי וחוות דעת חשובים לפני חתימה.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/overseas-partnership-guide.webp"
  },
  {
    "slug": "portugal-real-estate-financing",
    "title": "מימון רכישת נדל״ן בפורטוגל: משכנתה מקומית מול מימון מישראל",
    "excerpt": "השוואת מסלולי מימון לרכישת נדל״ן בפורטוגל: משכנתה מבנק מקומי מול מימון מישראל, שיקולי מטבע וריבית, ההשלכות המשפטיות והמיסויות, ומה בודקים לפני שבוחרים מסלול.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/ai-realestate-risk-management.webp"
  },
  {
    "slug": "portugal-legal-due-diligence",
    "title": "בדיקת נאותות משפטית לנכס בפורטוגל: מה בודקים, וכיצד Legal AI מזרז",
    "excerpt": "מדריך לבדיקת נאותות משפטית לנכס בפורטוגל: אימות זכויות ורישום, מסמכי הנכס, שעבודים וחריגות בנייה, ההבדל מהמרשם הישראלי, וכיצד כלי Legal AI מזרזים את הבדיקה בפיקוח עורך דין.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/why-realestate-needs-ai.webp"
  },
  {
    "slug": "eu-ai-act-roles-obligations",
    "title": "חובות לפי תפקיד ב-EU AI Act: ספק, מטמיע, מפיץ ומייבא",
    "excerpt": "מדריך לחלוקת החובות ב-EU AI Act לפי תפקיד בשרשרת האספקה: מה חב ספק (Provider), מה חב מטמיע (Deployer), ומה חבים מפיץ ומייבא, מתי מטמיע הופך לספק, ואיך חברה ישראלית ממפה את תפקידה לפני שהיא בונה תוכנית ציות.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/ai-workspace-encyclopedia.webp"
  },
  {
    "slug": "eu-ai-act-conformity-file-preparation",
    "title": "הכנת תיק תאימות (Conformity File) למערכת AI: מדריך שלב אחר שלב",
    "excerpt": "מדריך מעשי להכנת תיק התאימות הנדרש למערכת בינה מלאכותית בסיכון גבוה לפי חוק ה-AI האירופי: תשעת הפרקים שחובה לכלול, החיבור לניהול הסיכונים ולהצהרת התאימות, ההקלה לעסקים קטנים ובינוניים, ומשך השמירה הנדרש.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/ai-legal-practice.webp"
  },
  {
    "slug": "ai-product-liability-eu",
    "title": "אחריות מוצר ל-AI: מה משנה הוראת אחריות המוצר האירופית החדשה",
    "excerpt": "מדריך לאחריות מוצר על מערכות בינה מלאכותית לפי הוראת אחריות המוצר האירופית המעודכנת: הכללת תוכנה ו-AI בהגדרת מוצר, ההקלה בנטל ההוכחה על הנפגע, מי חשוף, ההצטלבות עם EU AI Act, ומה חברה ישראלית שמוכרת מוצר AI לאירופה צריכה לעשות.",
    "date": "ספטמבר 2026",
  ...
  {
    "slug": "california-sb574-ai-adjudication-ban",
    "title": "האצלת שיקול דעת שיפוטי לבינה מלאכותית: קליפורניה אוסרת זאת בחוק (SB 574)",
    "excerpt": "חוק SB 574 בקליפורניה, שממתין לחתימת המושל, אוסר על שופטים ובוררים להאציל שיקול דעת הכרעתי לבינה מלאכותית, ומטיל חובת אימות אסמכתאות מחמירה על עורכי דין, בליטיגציה ובבוררות כאחד.",
    "date": "ספטמבר 2026",
    "cover": "/images/covers/decision-oriented-ai-law.webp"
  },
];
