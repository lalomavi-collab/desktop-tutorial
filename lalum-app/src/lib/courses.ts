...
export const courses: Course[] = [
  ...
  },
  {
    ...
    sessions: [
      { n: 1, title: "היסודות, ארכיטקטורת AI במגזר הציבורי והנדסת פרומפטים למסמכי רשות" },
      { n: 2, title: "ניתוח מסמכים מרובים (RAG): פרוטוקולים, החלטות ועדה ותיקי רישוי בזמן אמת" },
      { n: 3, title: "מה מותר ומה אסור, מנהל תקין, חובת ההנמקה, הגנת פרטיות ואיסור האצלת שיקול דעת" },
      { n: 4, title: "מכרזים, אכיפה מנהלית וחופש המידע בעידן ה-AI" },
      { n: 5, title: "סדנת פיתוח מעשית, בניית מנוע הציות ומענה חופש המידע של הרשות" },
  ...
  },
  {
    ...
    sessions: [
      { n: 1, title: "היסודות, ארכיטקטורת AI בעולם הרכב והנדסת פרומפטים לחוזים ולרגולציה" },
      { n: 2, title: "ניתוח מסמכים מרובים (RAG): הסכמי הפצה, אחריות ותקני בטיחות בזמן אמת" },
  ...
  },
  {
    ...
    sessions: [
      { n: 1, title: "היסודות, ארכיטקטורת AI ברפואה והנדסת פרומפטים למסמכים קליניים ומשפטיים" },
      { n: 2, title: "ניתוח מסמכים מרובים (RAG): הסכמות מדעת, פרוטוקולי מחקר ותיקי מכשור בזמן אמת" },
  ...
  },
  {
    ...
    sessions: [
      { n: 1, title: "היסודות, ארכיטקטורת AI בפיננסים והנדסת פרומפטים לחוזים ולרגולציה" },
      { n: 2, title: "ניתוח מסמכים מרובים (RAG): מדיניות, הסכמים והוראות רגולטור בזמן אמת" },
  ...
  },
  {
    ...
    sessions: [
      { n: 1, title: "היסודות, ארכיטקטורת AI בתשתיות והנדסת פרומפטים לחוזים ולרישוי" },
      { n: 2, title: "ניתוח מסמכים מרובים (RAG): מכרזים, היתרים ותקני בטיחות בזמן אמת" },
